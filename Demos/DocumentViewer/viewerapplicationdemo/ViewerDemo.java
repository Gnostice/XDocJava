...
ActionListener, ItemListener, WindowListener, DocumentViewerListener, DocumentPrintListener
{
    ...
    private JRadioButtonMenuItem radioMnuDPI_USEDEVICE;
    ...
    private ButtonGroup radBtnGroupDPI;
    ...
    public ViewerDemo()
    {
        ...
        DocumentFileFilter allSupportedFormats = new DocumentFileFilter("All XDoc Supported Files");
        fc.addChoosableFileFilter(allSupportedFormats);
        fc.addChoosableFileFilter(new DocumentFileFilter("*.pdf"));
        fc.addChoosableFileFilter(new DocumentFileFilter("*.docx"));
        
        //Set Default
        fc.setFileFilter(allSupportedFormats);
        ...
        aboutDialog = new AboutGnosticeXDOCJava(this);
        aboutDialog.setModal(true);

        docInfoDialog = new DocumentInfoDialog(this);
        docInfoDialog.setModal(true);

        // Listen to windowClosing event so that user preferences can
        // be stored
    ...
    private void setViewerPreferences()
    {
        ...
        viewer.getPreferences().getPasswordSettings().setAttempts(2);
        viewer.getPreferences().getPasswordSettings().setShowDialog(true);
        viewer.getPreferences().getRenderingSettings().getText().setTextAntiAlias(TextAntiAlias.DEFAULT);
    }
    ...
    private void createMenus()
    {
        ...
        radBtnGroupDPI = new ButtonGroup();
        ...
        radioMnuDPI_USEDEVICE = new JRadioButtonMenuItem("Use Device DPI");
        radioMnuDPI_USEDEVICE.addActionListener(this);

        radBtnGroupDPI.add(radioMnuDPI_72);
        radBtnGroupDPI.add(radioMnuDPI_96);
        radBtnGroupDPI.add(radioMnuDPI_110);
        radBtnGroupDPI.add(radioMnuDPI_USEDEVICE);
        ...
        viewDPISubMenu.add(radioMnuDPI_USEDEVICE);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        try
        {
            ...
            else if (sourceButton == radioMnuDPI_USEDEVICE)
            {
                if (radioMnuDPI_USEDEVICE.isSelected())
                {
                    viewer.getPreferences().getRenderingSettings().getResolution().setResolutionMode(ResolutionMode.USE_DEVICE);
                }
            }
